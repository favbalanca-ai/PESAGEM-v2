...
function lerDisplay(frames,contexto){
  ...
  var prompt="Você é um sistema especializado em leitura de balanças agrícolas.\n\nAnalise as imagens do display digital de uma balança de caminhão.\nAlguns dígitos podem estar apagados em certas imagens (efeito estroboscópio em displays LED).\n\nCONTEXTO: "+s(contexto||"Balança agrícola, peso em kg")+"\n\nREGRAS:\n- Retorne APENAS JSON, sem texto adicional\n- O peso é sempre em kg, número inteiro positivo\n- Valores típicos: entre 3.000 kg e 80.000 kg\n- Use o valor mais frequente entre os frames legíveis\n- Se menos de 2 frames forem legíveis, retorne confianca: baixa\n- Ignore frames com dígitos completamente apagados\n\nFORMATO DE RESPOSTA (JSON puro, sem markdown):\n{\"peso_kg\": 14520, \"confianca\": \"alta\", \"leituras\": [14520, 14520, null], \"obs\": \"\"}";
